...
def _init_device_once() -> sh1107:
    ...
    # Changed to rotate=3 to flip the display upside down (180 degrees from rotate=1).
    dev = sh1107(serial, width=OLED_WIDTH, height=OLED_HEIGHT, rotate=3)  # type: ignore[operator]
